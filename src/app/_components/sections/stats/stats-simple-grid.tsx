          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Drive the Future with Our Premium Car Rentals
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Experience exceptional engineering and seamless development in every journey. Your ideal ride is just a click away.
              </p>
            </div>
